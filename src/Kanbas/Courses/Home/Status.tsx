...
import { FaCheckCircle, FaHome, FaRegChartBar } from "react-icons/fa";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "300px" }}>
      ...
      <button className="btn btn-lg btn-secondary w-100 mt-1 text-start">
        <FaRegChartBar className="me-2 fs-5" /> View Course Screen </button>

      <button className="btn btn-lg btn-secondary w-100 mt-1 text-start">
        <CiBullhorn className="me-2 fs-5" /> New Announcement </button>
      
      <button className="btn btn-lg btn-secondary w-100 mt-1 text-start">
        <FaRegChartBar className="me-2 fs-5" /> New Anayltics </button>
